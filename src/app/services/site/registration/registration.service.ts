...
export class RegistrationService {
  ...
  public signUp(params:ICreateProfileRequest) {
    try { this._signUp(params) }
      ...
      this.events.onError.next({ signature: '86d0caaa-907a-4782-b10d-7fb81b64213c', details: error })
    }
  }
  ...
  private onAuthProfileCreateOutcome(outcome) {
    try { this._onAuthProfileCreateOutcome(outcome) }
      ...
      this.events.onError.next({ signature: 'af47894b-0de0-46d9-9037-813ff566e987', details: error })
    }
  }
  ...
  private onLoginProfileCreateOutcome(outcome) {
    try { this._onLoginProfileCreateOutcome(outcome) }
      ...
      this.events.onError.next({ signature: 'ffac3e39-3ec0-4035-83d5-4002576dbc1b', details: error })
    }
  }
  ...
  private get isFinished() {
    try { return this._isFinished() }
      ...
      this.events.onError.next({ signature: '2755d121-7dda-41ea-af2b-40cf8353ae24', details: error })
    }
  }
