...
import { IDeleteRequest, IDeleteResponse } from '../../../../assets/interfaces/login-server-service-interface/IDelete.interface'
import { IReadAuthIdRequest, IReadAuthIdResponse } from '../../../../assets/interfaces/login-server-service-interface/IReadAuthId.interface'
import { IReadUserIdRequest, IReadUserIdResponse } from '../../../../assets/interfaces/login-server-service-interface/IReadUserId.interface'
      ...
      private _attemptLogin(params) {
        this.auth.attemptAuth(params)
          ...
          private onAuthFailure(error:IAttemptAuthResponse) {  console.error('error-34f0e29f-e87d-47e5-9f25-df344ae896f5', error)
            this.events.onLoginOutcome.next({ success: false, details: `cognito:${ error.thirdParty.code }` })
          }
