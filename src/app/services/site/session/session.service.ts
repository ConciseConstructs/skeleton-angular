...
export class SessionService {
    ...
    this.checkIfSessionExists()
      ...
      private clearSessionIfOutdated() {
        try { this._clearSessionIfOutdated() }
          ...
          this.events.onError.next({ signature: 'df61b0ca-c09a-4674-bed5-daa235268ba0', details: error })
        }
      }
  ...
  private onLoginOutcome(outcome) {
    try { this._onLoginOutcome(outcome) }
      ...
      this.events.onError.next({ signature: '97d197c2-9852-4055-9e29-0252bad9e728', details: error })
    }
  }
  ...
  public get authId():string {
    try { return this._authId() }
      ...
      this.events.onError.next({ signature: '759bc025-ef88-4ec1-bc47-f02dfc101c3b', details: error })
    }
  }
  ...
  public get acctId():string {
    try { return this._acctId() }
      ...
      this.events.onError.next({ signature: 'ab2c1030-29c9-4b03-b3b8-a2b8b909b427', details: error })
    }
  }
  ...
  public get userId():string {
    try { return this._userId() }
      ...
      this.events.onError.next({ signature: 'a43fece5-fbb0-4112-a3c9-625692fe0d3e', details: error })
    }
  }
  ...
  public get timestamp() {
    try { return this._timestamp() }
      ...
      this.events.onError.next({ signature: '1ffc4522-cc17-4523-8cc1-ffd88750b18b', details: error })
    }
  }
