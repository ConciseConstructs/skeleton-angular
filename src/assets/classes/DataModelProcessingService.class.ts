...
export abstract class DataModelProcessingService {
  ...
  public loadRecords() {
    try { return this._loadRecords() }
      ...
      this.events.onError.next({ signature: 'error-bbc3a499-97b4-44c1-a64b-bd2877bc3ea3', details: error })
    }
  }
        ...
        return this.executeLoad()
          ...
          protected executeLoad() {
            this.api[this.modelName].getRecords(sessionStorage.getItem('acctId'))
              ...
              protected onGetRecordsFailure(error) {
                this.events.onError.next({ signature: 'error-31c04768-ae2d-4dc8-87ee-92f3b8808b5c', details: error })
  ...
  public getId(id:string):any {
    try { return this._getId(id) }
      ...
      this.events.onError.next({ signature: 'error-68dc2660-51ad-46ed-8e12-a5c02577fad4', details: error })
    }
  }
  ...
  public save(params:Model):Promise<StandardReturn> {
    try { return this._save(params) }
      ...
      this.events.onError.next({ signature: 'error-b925109f-8f3e-4f1b-90df-840478a12d8b', details: error })
    }
  }
  ...
  public update(params:Model):Promise<StandardReturn> {
    try { return this._update(params) }
      ...
      this.events.onError.next({ signature: 'error-03bb99c8-1aa2-4e3a-b2c3-01e3c1c685c8', details: error })
    }
  }
  ...
  public remove(params:{ accountId:string, id:string }):Promise<StandardReturn> {
    try { return this._remove(params) }
      ...
      this.events.onError.next({ signature: 'error-dc2fa50d-d1b0-4f38-b95a-b9e1cba57f97', details: error })
    }
  }
  ...
  public get records():Model[] {
    ...
    catch (error) { this.events.onError.next({ signature: 'error-863e6f4f-a7c2-4dee-bdc1-c552dfc02925', details: error }) }
  }
