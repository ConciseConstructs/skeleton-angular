...
export class SchedulerComponent implements OnInit {
  ...
  public get uiFirstQuiz() {
    ...
    catch (error) { this.onError({ signature: 'd46b46b5-27c6-4cd0-893a-abf08a3d5473', details: error }) }
  }
  ...
  private emit() {
    try { this._emit() }
    catch (error) { this.onError({ signature: 'df8179c2-e939-42af-ace4-be70a54bb30f', details: error }) }
  }
